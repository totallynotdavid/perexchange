...
SOURCE = "dinekash"
BUY_URL = "https://api.dinekash.pe/cotizacion/buscar/USDPEN"
SELL_URL = "https://api.dinekash.pe/cotizacion/buscar/PENUSD"
...
fetch_dinekash = dual_endpoint_json_scraper(SOURCE, BUY_URL, SELL_URL, _parse_json)
